...
import org.openmrs.module.kenyaemraccident.api.impl.AccidentServiceImpl;
import static org.mockito.Mockito.*;
import static org.hamcrest.Matchers.*;
import static org.junit.Assert.*;

/**
 * This is a unit test, which verifies logic in AccidentService. It doesn't extend
 * BaseModuleContextSensitiveTest, thus it is run without the in-memory DB and Spring context.
 */
public class AccidentServiceTest {
	
	@InjectMocks
	AccidentServiceImpl basicModuleService;
